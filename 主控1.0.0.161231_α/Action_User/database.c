...
gun_pose_t gLeftGunPosDatabase[SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
		...
		//第二类参数，对应新盘落盘参数
		{//1#着陆台
		  {-36.6f, 22.0f, 11.9f, 18.0f, 100.0f},
		 //2#着陆台
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 {-22.2f, 25.2f, 6.0f, 19.0f, 95.0f},
		 //3#着陆台
...
//		 {1.9f,8.0f, -1.4f,130.0f,23.0f},
		...
		{//1#着陆台
		 ...
		 //4#着陆台
		 {17.9f,23.7f,16.0f,88.0f,20.0f},
		 //5#着陆台
		 {34.4f,21.4f,17.0f,99.0f,15.0f},//myh
		 //6#着陆台
...
//		 {1.9f,8.0f, -1.4f,130.0f,23.0f},
		...
		{//1#着陆台
		 ...
		 {17.9f,23.7f,16.0f,88.0f,20.0f},
		 //5#着陆台
		 {34.9f,21.4f,17.0f,100.0f,16.0f},//myh
		 //6#着陆台
		 {3.5f,21.4f,6.5f,130.0f,16.0f},
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}},

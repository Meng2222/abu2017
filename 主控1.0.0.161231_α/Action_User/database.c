...
/*******************************蓝场参数********************************/
	 ...
	 //第二组参数，对应场地中间发射点参数
	{
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-33.2f, 18.6f, 15.9f, 17.0f, 76.5f},
		 //2#着陆台
		 {-17.3f, 25.0f, 14.1f, 21.0f, 72.0f},
		 //3#着陆台
		 {-1.3f, 30.9f, 0.6f, 16.0f, 86.5f},
		 //4#着陆台
		 {23.0f, 24.2f, 12.1f, 21.0f,77.0f},
		 //5#着陆台
		 {33.9f,18.0f,7.2f,18.5f,81.0f},
		 //6#着陆台
		 {-4.1f,19.0f,0.5f,8.0f,112.5f},
		 //7#着陆台
		 {4.5f, 36.2f,2.5f,15.0f,45.0f}}
	 },
	//第三组参数，对应右侧发射点参数
...
/*****************************蓝场参数***************************/
	 ...
	 //第二组参数，对应场地中央发射点参数
	{
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-36.4f, 17.9f, 14.7f, 79.0f, 18.5f},
		 //2#着陆台
		 {-21.5f, 24.4f, 12.6f, 77.0f, 19.5f},
		 //3#着陆台
		 {2.1f, 28.7f, 1.3f, 81.0f, 21.5f},
		 //4#着陆台
		 {16.5f,24.8f,15.0f,72.0f,21.0f},
		 //5#着陆台
		 {34.1f,18.5f,15.9f,77.0f,18.0f},
		 //6#着陆台
		 {6.6f ,20.6f,0.8f,100.0f,21.0f},
		 //7#着陆台
...
/**************************蓝场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.8f, -6.2f, 0.0f, 135.0f, 10.0f},
				{-4.8f, -6.1f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -6.2f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -5.9f, 0.0f, 135.0f, 10.0f},
				{3.7f, -6.2f, 0.0f, 135.0f, 10.0f},
				{3.7f, -5.9f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{
				{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},

...
gun_pose_t gLeftGunPosDatabase[SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
		...
		//第二类参数，对应新盘落盘参数
		{//1#着陆台
		  {-28.1f, 18.5f, 21.4f, 16.0f, 93.0f},
		 //2#着陆台
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 {-15.5f, 23.9f, 14.1f, 16.0f, 93.0f},
		 //3#着陆台
		 {2.2f, 27.4f, 6.6f, 19.0f, 95.0f},
		 //4#着陆台
		 {21.9f, 22.7f, 8.0f, 14.0f,96.0f},
		 //5#着陆台
		 {39.2f,17.1f, 13.9f,14.0f,97.0f},//myh
		 //6#着陆台
		 {0.9f,14.8f,8.5f,18.0f,112.0f},//myh
		 //{-3.6f,19.8f,2.0f,21.0f,124.0f}
		 //7#着陆台
		 {4.5f,36.2f, 2.0f,16.0f,52.0f}},
		
		//第三类参数，对应打球同时落盘参数
		{//1#着陆台
		 {-24.5f, 15.0f, 22.6f, 0.0f, 113.0f},
		 //2#着陆台
		 {-17.4f, 12.7f, 1.8f, 12.0f, 113.0f},
		 //3#着陆台
		 {1.5f, 23.3f, -0.9f, 7.0f, 110.0f},
		 //4#着陆台
		 {29.4f, 17.5f, 12.8f, 0.0f,113.0f},
		 //5#着陆台
		 {38.6f,13.0f, 8.4f,0.0f,112.0f},
		 //6#着陆台
		 {0.9f,14.3f,8.0f,18.0f,112.0f},//myh
		 //7#着陆台
...
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		...
		//第六类参数，对应新盘补弹落盘参数
		{//1#着陆台
		  {-28.6f, 19.0f, 21.4f, 16.0f, 93.0f},
		 //2#着陆台
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 {-16.0f, 24.4f, 14.1f, 16.0f, 92.0f},
		 //3#着陆台
		 {2.2f, 27.4f, 6.6f, 19.0f, 95.0f},
		 //4#着陆台
		 {21.4f, 22.7f, 8.0f, 14.0f,96.0f},
		 //5#着陆台
		 {39.2f,17.1f, 13.9f,14.0f,97.0f},//myh
		 //6#着陆台
		 {0.9f,14.8f,8.5f,18.0f,112.0f},//myh
...
gun_pose_t gLeftGunReloadPosDatabase[SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
		...
		//第二类参数，对应新盘落盘参数
		{//1#着陆台
		  {-28.1f, 17.5f, 21.4f, 15.0f, 91.0f},
		 //2#着陆台
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 {-15.5f, 22.4f, 14.1f, 15.0f, 92.0f},
		 //3#着陆台
		 {2.2f, 27.4f, 6.6f, 19.0f, 95.0f},
		 //4#着陆台
		 {16.9f, 23.2f, 2.0f, 18.0f,98.0f},
		 //5#着陆台
		 {37.2f,18.1f, 11.4f,15.0f,97.0f},//myh
		 //6#着陆台
		 {0.9f,14.8f,8.5f,18.0f,112.0f},//myh
		 //{-3.6f,19.8f,2.0f,21.0f,124.0f}
		 //7#着陆台
...
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 ...
		 {2.2f, 27.4f, 6.6f, 19.0f, 95.0f},
		 //4#着陆台
		 {20.4f, 22.7f, 6.5f, 12.0f,97.0f},
		 //5#着陆台
		 {39.2f,15.6f, 13.9f,14.0f,96.0f},//myh
		 //6#着陆台
		 {0.9f,14.8f,8.5f,18.0f,112.0f},//myh
		 //{-3.6f,19.8f,2.0f,21.0f,124.0f}
		 //7#着陆台
...
//		 {1.9f,8.0f, -1.4f,130.0f,23.0f},
		...
		//第二类参数，对应新盘落盘参数
		{//1#着陆台
		 {-37.7f, 15.1f, 13.9f, 97.0f, 15.0f},
		 //2#着陆台
		 {-22.5f, 22.4f, 15.5f, 91.0f, 18.0f},
		 //3#着陆台
		 {2.8f, 26.2f, 6.1f, 93.0f, 20.0f},
		 //4#着陆台
		 {18.4f,22.7f,14.0f,90.0f,16.0f},
		 //5#着陆台
		 {37.4f,17.4f,12.0f,95.0f,13.0f},//myh
		 //6#着陆台
		 {-0.1f,14.3f,9.5f,113.0f,18.0f},//myh
		 //7#着陆台
		...
		{//1#着陆台
		 ...
		 {-5.5f, 23.5f, 12.7f, 111.0f, 5.0f},
		 //4#着陆台
		 {12.3f,19.4f,17.0f,108.0f,0.0f},
		 //5#着陆台
		 {29.1f,8.8f,17.0f,114.0f,10.0f},//yhy
		 //6#着陆台
		 {0.4f,14.3f,9.5f,116.0f,17.0f},//myh
//		 {1.4f,10.0f,2.1f,118.0f,25.0f},
		...
		{//1#着陆台
		 ...
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}},
		//第五类参数，对应新盘补弹打球参数/孟雨皞是个智障
		{//1#着陆台
		 {-35.0f, 8.0f, 4.0f, 104.0f, 14.0f},
		 //2#着陆台
		 ...
		 //5#着陆台
		 {30.1f,9.0f,17.0f,103.0f,10.0f},//myh
		 //6#着陆台
		 {0.4f,14.3f,9.5f,116.0f,17.0f},//myh
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}},
		//第六类参数，对应新盘补弹落盘参数/孟雨皞是个智障
		{//1#着陆台
		 {-37.2f, 15.1f, 13.9f, 97.0f, 15.0f},
		 //2#着陆台
		 {-22.5f, 22.4f, 15.5f, 91.0f, 18.0f},
		 //3#着陆台
		 {2.8f, 26.2f, 6.1f, 93.0f, 20.0f},
		 ...
		 {18.4f,22.7f,14.0f,90.0f,16.0f},
		 //5#着陆台
		 {37.9f,17.4f,12.0f,95.0f,13.0f},//myh
		 //6#着陆台
		 {-0.1f,14.3f,9.5f,113.0f,18.0f},//myh
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}}
...
//		 {1.9f,8.0f, -1.4f,130.0f,23.0f},
		...
		{//1#着陆台
		 ...
		 {2.8f, 26.2f, 6.1f, 93.0f, 20.0f},
		 //4#着陆台
		 {18.4f,21.7f,14.0f,93.0f,15.0f},
		 //5#着陆台
		 {38.4f,17.4f,12.0f,99.0f,11.0f},//myh
		 //6#着陆台
		 {0.4f,14.3f,9.5f,116.0f,17.0f},//myh
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}},
...
gun_pose_t gUpperGunPosDatabase[LAND_NUMBER][UPPER_SHOOT_METHOD_NUMBER][ZONE_NUMBER] = \
{
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			{-7.2f, -5.0f, 0.0f, 126.0f, 0.0f},
			{-4.4f, -4.3f, 0.0f, 126.0f, 0.0f},
			{-2.0f, -5.0f, 0.0f, 126.0f, 0.0f},			
			{-1.4f, -4.0f, 0.0f, 126.0f, 0.0f},
			{4.6f, -3.5f, 0.0f, 126.0f, 0.0f},
			{4.0f, -4.3f, 0.0f, 126.0f, 0.0f}
		},
		//第四种参数类型对应补弹打球
		{
			{0.8f, 1.3f, 0.0f, 114.0f, 0.0f},

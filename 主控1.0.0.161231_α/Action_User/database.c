...
gun_pose_t gLeftGunPosDatabase[SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
		...
		//第一类参数，对应打球同时落盘参数
		{//1#着陆台
		 {-26.7f, 10.9f, 16.4f, 0.0f, 116.0f},
		 //2#着陆台
		 {-10.4f, 16.2f, 16.9f, 4.0f, 111.0f},
		 //3#着陆台
		 {2.5f, 22.8f, -0.9f, 7.0f, 110.0f},
		 //4#着陆台
		 {29.4f, 15.0f, 12.8f, 0.0f,116.0f},
		 //5#着陆台
		 {41.5f,8.8f, 9.4f,10.0f,107.0f},
		 //6#着陆台
		 {-2.8f,10.0f, -4.0f,21.0f,128.0f},
		 //7#着陆台
		 {6.0f, 25.9f,2.0f,16.0f,77.0f}},
		//第二类参数，对应新盘自动落盘参数
		{//1#着陆台
		  {-32.2f, 15.7f, 18.7f, 17.0f, 89.0f},
		 //2#着陆台
		 {-15.5f, 22.9f, 14.1f, 14.0f, 92.0f},
		 //3#着陆台
		 {0.2f, 27.4f, 6.6f, 19.0f, 90.0f},
		 //4#着陆台
		 {21.4f, 22.2f, 8.0f, 13.0f,95.0f},
		 //5#着陆台
		 {31.5f,17.1f, 1.1f,8.0f,105.0f},
		 //6#着陆台
		 {-6.5f,19.4f,-2.3f,13.0f,127.0f},
		 //7#着陆台
...
//		 {1.4f,10.0f,2.1f,118.0f,25.0f},
		...
		//第二类参数，对应新盘自动落盘参数
		{//1#着陆台
		 {-31.0f, 17.1f, 1.1f, 107.0f, 10.0f},
		 //2#着陆台
		 {-24.0f, 22.4f, 15.5f, 90.0f, 18.0f},
		 //3#着陆台
		 {0.3f, 27.7f, 6.1f, 97.0f, 15.0f},
		 //4#着陆台
		 {18.4f,23.2f,14.0f,92.0f,16.0f},
		 //5#着陆台
		 {34.4f,16.9f,18.5f,90.0f,19.0f},
		 //6#着陆台
		 {7.5f,19.4f,0.6f,124.0f,15.0f},
		 //7#着陆台

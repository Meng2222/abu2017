...
/******************************红场参数*****************************/
	 ...
	 //第二组参数，对应场地中间发射点参数
	{
		...
		//第三类参数，对应新盘补弹打球参数
		{//1#着陆台
		 {-28.0f, 9.5f, 13.9f, 5.0f, 114.0f},
		 //2#着陆台
		 {-11.9f, 15.7f, 16.4f, 4.0f, 112.0f},
		 //3#着陆台
		 {8.2f, 22.9f, 11.6f, 12.0f, 95.0f},
		 //4#着陆台
		 {26.9f, 16.0f, 12.8f, 0.0f,117.0f},
		 //5#着陆台
		 {40.5f,7.5f, 8.4f,12.0f,111.0f},
		 //6#着陆台
		 {-4.7f,11.9f, -1.9f,29.0f,126.0f},
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-32.2f, 17.6f, 15.9f, 17.5f, 78.0f},
		 //2#着陆台
		 {-17.8f, 22.5f, 9.6f, 20.5f, 75.0f},
		 //3#着陆台
		 {-0.8f, 27.4f, 1.6f, 15.5f, 84.5f},
		 //4#着陆台
		 {21.0f, 21.7f, 9.0f, 21.0f,77.5f},
		 //5#着陆台
		 {33.9f,18.0f,7.2f,19.0f,82.0f},
		 //6#着陆台
		 {-6.3f,18.7f,-2.0f,13.6f,107.3f},
		 //7#着陆台
		 {5.0f, 37.2f,2.5f,15.0f,46.0f}}
	 },
	//第三组参数，对应右侧发射点参数
	{
		//第一类参数，对应打球同时落盘参数
...
/*******************************蓝场参数********************************/
	 ...
	 //第二组参数，对应场地中间发射点参数
	{
		...
		//第三类参数，对应新盘补弹打球参数
		{//1#着陆台
		 {-28.0f, 10.0f, 13.9f, 5.0f, 114.0f},
		 //2#着陆台
		 {-11.4f, 16.7f, 16.4f, 4.0f, 112.0f},
		 //3#着陆台
		 {9.2f, 25.4f, 11.6f, 12.0f, 91.0f},
		 //4#着陆台
		 {28.9f, 15.0f, 12.8f, 0.0f,117.0f},
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-33.2f, 20.1f, 15.9f, 17.0f, 78.0f},
		 //2#着陆台
		 {-14.3f, 24.0f, 14.1f, 19.5f, 75.0f},
		 //3#着陆台
		 {0.2f, 30.9f, 1.6f, 16.0f, 86.5f},
		 //4#着陆台
		 {24.0f, 24.2f, 12.1f, 21.0f,77.0f},
		 //5#着陆台
		 {33.9f,18.0f,7.2f,18.5f,81.0f},
		 //6#着陆台
		 {-6.1f,20.6f,0.8f,22.0f,103.0f},
		 //7#着陆台
		 {4.5f, 36.2f,2.5f,15.0f,45.0f}}
	 },
	//第三组参数，对应右侧发射点参数
...
/************************红场参数************************/
	 ...
	 //第二组参数，对应场地中央发射点参数
	{
		...
		{//1#着陆台
		 ...
		 {-30.5f, 17.4f, 20.5f, 109.0f, 4.0f},
		 //3#着陆台
		 {-1.0f, 23.1f, 3.9f, 99.0f, 7.0f},
		 //4#着陆台
		 {10.5f,16.4f,21.0f,99.0f,16.5f},
		 //5#着陆台
		 {29.5f,7.8f, 18.0f,122.0f,16.0f},
		 //6#着陆台
		 {0.0f,11.9f,7.6f,116.0f,20.0f},
		 //7#着陆台
		 {-5.5f,26.9f, 7.5f,10.0f,70.0f}},
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-38.6f, 18.9f, 16.2f, 79.5f, 18.5f},
		 //2#着陆台
		 {-22.5f, 24.9f, 12.6f, 79.5f, 18.5f},
		 //3#着陆台
		 {2.1f, 28.7f, 3.3f, 81.5f, 21.0f},
		 //4#着陆台
		 {15.0f,26.3f,17.5f,77.5f,16.5f},
		 //5#着陆台
		 {33.3f,18.5f,17.4f,78.0f,18.0f},
		 //6#着陆台
		 {7.8f ,21.1f,1.2f,104.5f,20.5f},
		 //7#着陆台
...
/*****************************蓝场参数***************************/
	 ...
	 //第二组参数，对应场地中央发射点参数
	{
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-37.9f, 18.4f, 14.7f, 79.5f, 18.5f},
		 //2#着陆台
		 {-22.5f, 25.4f, 12.6f, 78.5f, 19.0f},
		 //3#着陆台
		 {3.1f, 28.7f, 1.3f, 81.0f, 22.0f},
		 //4#着陆台
		 {16.5f,24.8f,15.0f,72.0f,21.0f},
		 //5#着陆台
		 {33.6f,18.5f,15.9f,76.5f,18.0f},
		 //6#着陆台
		 {5.6f ,20.1f,2.3f,101.0f,21.0f},
		 //7#着陆台
		 {-3.5f,35.9f, 0.0f,45.0f,15.0f}}
	 },
	 //第三组参数，对应场地右侧发射点参数
...
/**************************红场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.6f, -4.6f, 0.0f, 135.0f, 10.0f},
				{-5.0f, -4.8f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -5.1f, 0.0f, 135.0f, 10.0f},
				{-0.4f, -5.0f, 0.0f, 135.0f, 10.0f},
				{3.7f, -4.9f, 0.0f, 135.0f, 10.0f},
				{4.7f, -5.0f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{
				{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},
...
/**************************蓝场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.8f, -3.0f, 0.0f, 135.0f, 10.0f},
				{-4.8f, -3.0f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -3.0f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -3.0f, 0.0f, 135.0f, 10.0f},
				{3.7f, -3.0f, 0.0f, 135.0f, 10.0f},
				{3.7f, -3.0f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{

...
/************************红场参数************************/
	 ...
	 //第二组参数，对应场地中央发射点参数
	{
		...
		{//1#着陆台
		 ...
		 //2#着陆台
		 {-23.0f, 25.4f, 12.6f, 78.5f, 19.0f},
		 //3#着陆台
		 {3.1f, 28.7f, 1.3f, 81.0f, 22.0f},
		 //4#着陆台
		 {17.0f,24.8f,15.0f,72.5f,21.0f},
		 //5#着陆台
		 {33.6f,18.5f,15.9f,76.5f,18.0f},
		 //6#着陆台
		 {6.1f ,20.1f,2.3f,101.5f,21.0f},
		 //7#着陆台
...
/**************************红场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.8f, -2.9f, 0.0f, 135.0f, 10.0f},
				{-4.8f, -2.9f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -2.9f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -2.9f, 0.0f, 135.0f, 10.0f},
				{3.7f, -3.0f, 0.0f, 135.0f, 10.0f},
				{3.7f, -2.9f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{
				{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},

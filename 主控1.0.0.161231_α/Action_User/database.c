...
/*******************************蓝场参数********************************/
		...
		{//1#着陆台
		 ...
		 //4#着陆台
		 {28.9f, 15.5f, 12.8f, 0.0f,117.0f},
		 //5#着陆台
		 {42.0f,7.0f, 8.4f,12.0f,111.0f},
		 //6#着陆台
		 {-2.0f,9.4f, -3.9f,23.0f,120.0f},
		 //7#着陆台
		 {6.0f, 25.4f,6.0f,16.0f,77.0f}},
		//第二类参数，对应新盘自动落盘参数
		{//1#着陆台
		 ...
		 //3#着陆台
		 {5.2f, 25.4f,11.6f, 19.0f, 91.0f},
		 //4#着陆台
		 {23.1f, 20.2f, 12.0f, 14.0f,91.0f},
		 //5#着陆台
		 {33.0f,13.6f,1.1f,9.0f,102.0f},
		 //6#着陆台
		 {-6.0f,16.4f,-1.8f,11.0f,120.0f},
		 //7#着陆台
		 {4.5f,36.2f, 2.0f,14.0f,50.0f}},
...
/*****************************蓝场参数***************************/
		 ...
		 //第一类参数，对应打球同时落盘参数
		{//1#着陆台
		 {-38.1f, 8.5f, 8.6f, 110.0f, 8.0f},
		 //2#着陆台
		 {-30.5f, 17.4f, 20.5f, 109.0f, 4.0f},
		 //3#着陆台
		 {-1.5f, 23.3f, 6.4f, 110.0f, 7.0f},
		 //4#着陆台
		 {11.3f,17.4f,20.0f,104.0f,7.0f},
		 //5#着陆台
		 {28.6f,8.3f, 18.0f,114.0f,9.0f},
		 //6#着陆台
		 {1.0f,12.9f,7.6f,116.0f,20.0f},
		 //7#着陆台
		 {-5.0f,25.4f, 7.5f,11.0f,77.0f}},
		
		//第二类参数，对应新盘自动落盘参数
		{//1#着陆台
		 {-39.0f, 13.6f, 17.1f, 98.0f, 15.0f},
		 //2#着陆台
		 {-25.5f, 19.4f, 20.5f, 90.0f, 19.0f},
		 //3#着陆台
		 {1.8f, 26.7f, 6.1f, 92.0f, 20.0f},
		 //4#着陆台
		 {20.5f,21.4f,11.1f,93.0f,16.0f},
		 //5#着陆台
		 {33.7f,14.2f,18.2f,92.0f,17.0f},
		 //6#着陆台
		 {5.0f,16.9f,4.2f,124.0f,14.0f},
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}},
...
/**************************红场参数*******************************/
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			...
			{-4.2f, -3.3f, 0.0f, 130.0f, 0.0f},
			{-1.2f, -2.7f, 0.0f, 130.0f, 0.0f},			
			{0.0f, -3.4f, 0.0f, 130.0f, 0.0f},
			{2.8f, -2.8f, 0.0f, 130.0f, 0.0f},
			{3.0f, -3.2f, 0.0f, 130.0f, 0.0f}
		},
		//第四种参数类型对应补弹打球
		{
			{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},

...
/******************************红场参数*****************************/
	 ...
	 //第二组参数，对应场地中间发射点参数
	{
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-32.7f, 20.6f, 15.9f, 17.5f, 78.0f},
		 //2#着陆台
		 {-17.8f, 24.0f, 9.6f, 20.5f, 75.0f},
		 //3#着陆台
		 {0.7f, 27.4f, 1.6f, 16.5f, 86.0f},
		 //4#着陆台
		 {23.0f, 24.2f, 12.1f, 21.0f,77.5f},
		 //5#着陆台
		 {33.9f,18.0f,7.2f,19.0f,82.0f},
		 //6#着陆台
		 {-6.3f,20.2f,-2.0f,16.1f,104.8f},
		 //7#着陆台
		 {4.5f, 36.2f,2.5f,15.0f,48.0f}}
	 },
	//第三组参数，对应右侧发射点参数
	{
		//第一类参数，对应打球同时落盘参数
...
/************************红场参数************************/
	 ...
	 //第二组参数，对应场地中央发射点参数
	{
		...
		{//1#着陆台
		 ...
		 {-30.5f, 17.4f, 20.5f, 109.0f, 4.0f},
		 //3#着陆台
		 {-1.5f, 24.1f, 3.9f, 99.0f, 7.0f},
		 //4#着陆台
		 {10.0f,18.4f,21.0f,99.0f,16.5f},
		 //5#着陆台
		 {29.0f,8.6f, 18.0f,122.0f,16.0f},
		 //6#着陆台
		 {0.0f,11.9f,7.6f,116.0f,20.0f},
		 //7#着陆台
		 {-5.5f,26.9f, 7.5f,10.0f,70.0f}},
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-38.1f, 18.9f, 16.7f, 79.5f, 18.5f},
		 //2#着陆台
		 {-23.5f, 25.4f, 13.1f, 79.0f, 18.5f},
		 //3#着陆台
		 {1.6f, 29.2f, 2.3f, 82.0f, 21.0f},
		 //4#着陆台
		 {13.0f,25.8f,17.5f,79.0f,17.0f},
		 //5#着陆台
		 {33.3f,18.5f,16.4f,76.5f,18.0f},
		 //6#着陆台
		 {6.8f ,21.1f,-0.2f,104.5f,20.5f},
		 //7#着陆台
...
/**************************红场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.8f, -4.3f, 0.0f, 135.0f, 10.0f},
				{-4.8f, -4.2f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -4.2f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -4.6f, 0.0f, 135.0f, 10.0f},
				{3.7f, -4.0f, 0.0f, 135.0f, 10.0f},
				{4.3f, -4.5f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{
				{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},

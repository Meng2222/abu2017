...
gun_pose_t gLeftGunPosDatabase[SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
		...
		{//1#着陆台
		 ...
		 //6#着陆台
		 {3.4f,15.3f,12.0f,21.0f,111.0f},
		 //7#着陆台
		 {5.5f, 25.4f, 7.9f,17.0f,81.0f}},

		//第二类参数，对应新盘落盘参数
		{//1#着陆台
		  {-27.6f, 18.5f, 21.4f, 14.0f, 93.0f},
		 //2#着陆台
...
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		...
		//第六类参数，对应新盘补弹落盘参数
		{//1#着陆台
		  {-34.1f, 20.2f, 16.0f, 21.0f, 95.0f},
		 //2#着陆台
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 {-22.2f, 24.7f, 6.0f, 19.0f, 95.0f},
		 //3#着陆台
		 {2.7f, 26.9f, 6.6f, 20.0f, 96.0f},
		 //4#着陆台
		 {21.4f, 22.7f, 8.0f, 14.0f,96.0f},
...
//		 {1.9f,8.0f, -1.4f,130.0f,23.0f},
		...
		//第二类参数，对应新盘落盘参数
		{//1#着陆台
		 {-35.2f, 14.6f, 13.9f, 99.0f, 16.0f},
		 //2#着陆台
		 {-22.0f, 22.4f, 15.5f, 92.0f, 19.0f},
		 //3#着陆台
		 {2.8f, 24.4f, 6.1f, 92.0f, 22.0f},
		 //4#着陆台
		 {20.4f,22.7f,14.0f,91.0f,17.0f},
		 //5#着陆台
		 {38.9f,16.9f,12.0f,97.0f,15.0f},
		 //6#着陆台
		 {2.5f,20.9f,6.5f,131.0f,15.0f},
		 //7#着陆台

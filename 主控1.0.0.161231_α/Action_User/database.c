...
/*******************************蓝场参数********************************/
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-33.0f, 17.7f, 18.2f, 16.0f, 83.0f},
		 //2#着陆台
		 {-19.0f, 22.9f, 11.1f, 14.0f, 85.0f},
		 //3#着陆台
		 {-0.3f, 26.9f,3.6f, 16.0f, 89.0f},
		 //4#着陆台
		 {23.6f, 22.7f, 12.0f, 16.0f,86.0f},
...
/*****************************蓝场参数***************************/
		...
		{//1#着陆台
		 ...
		 //4#着陆台
		 {12.8f,19.2f,20.0f,104.0f,7.0f},
		 //5#着陆台
		 {29.6f,9.4f, 18.0f,122.0f,9.0f},
		 //6#着陆台
		 {0.0f,11.9f,7.6f,116.0f,20.0f},
		 //7#着陆台
		 {-5.5f,26.9f, 7.5f,10.0f,70.0f}},
		...
		{//1#着陆台
		 ...
		 {21.0f,22.4f,12.1f,86.0f,15.0f},
		 //5#着陆台
		 {36.5f,16.2f,18.2f,85.0f,17.0f},
		 //6#着陆台
		 {5.7f,17.9f,2.1f,117.0f,18.0f},
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,45.0f,15.0f}}		
#endif		 
...
/**************************蓝场参数*******************************/
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			{-5.1f, -2.6f, 0.0f, 145.0f, 0.0f},
			{-4.7f, -2.6f, 0.0f, 145.0f, 0.0f},
			{-0.7f, -2.7f, 0.0f, 145.0f, 0.0f},			
			{-1.1f, -2.9f, 0.0f, 145.0f, 0.0f},
			{3.9f, -2.7f, 0.0f, 145.0f, 0.0f},
			{3.1f, -3.0f, 0.0f, 145.0f, 0.0f}
		},
		//第四种参数类型对应补弹打球

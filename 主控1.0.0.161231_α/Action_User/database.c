...
/*****************************蓝场参数***************************/
		...
		//第二类参数，对应新盘自动落盘参数
		{//1#着陆台
		 {-29.5f, 13.6f, 0.6f, 106.0f, 12.0f},
		 //2#着陆台
		 {-22.5f, 22.4f, 15.5f, 93.0f, 19.0f},
		 //3#着陆台
		 {1.8f, 26.7f, 6.1f, 92.0f, 20.0f},
		 //4#着陆台
		 {18.9f,23.2f,14.0f,94.0f,16.0f},
		 //5#着陆台
		 {34.9f,16.4f,18.5f,91.0f,18.0f},
		 //6#着陆台
		 {6.5f,16.4f,0.5f,128.0f,10.0f},
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}},

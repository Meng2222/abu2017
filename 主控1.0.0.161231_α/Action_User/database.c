...
/*******************************蓝场参数********************************/
	 ...
	 //第二组参数，对应场地中间发射点参数
	{
		...
		{//1#着陆台
		 ...
		 //2#着陆台
//		 {-15.8f, 24.5f, 8.1f, 19.0f, 75.5f},
//		 {7.0f, 31.7f, 7.0f, 10.5f, 42.5f},
		 {6.6f, 37.2f,2.5f,15.0f,46.0f},		 
		 //3#着陆台
		 {5.4f, 30.7f, 6.3f, 9.6f, 56.4f},
		 //4#着陆台
		 {22.5f, 24.1f, 8.0f, 17.5f,80.0f},
		 //5#着陆台
		 {34.4f,16.5f,6.2f,17.0f,82.0f},
		 //6#着陆台
		 {-5.3f,20.6f,2.9f,18.1f,137.6f},
		 //7#着陆台
		 {6.6f, 37.2f,2.5f,15.0f,46.0f}}
	 },
	//第三组参数，对应右侧发射点参数
...
/**************************红场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-5.2f, -5.0f, 0.0f, 135.0f, 10.0f},
				{-5.8f, -5.4f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -5.6f, 0.0f, 135.0f, 10.0f},
				{-0.4f, -5.2f, 0.0f, 135.0f, 10.0f},
				{3.7f, -5.2f, 0.0f, 135.0f, 10.0f},
				{4.7f, -5.5f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{
				{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},
...
/**************************蓝场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.2f, -2.2f, 0.0f, 148.3f, 12.8f},
				{-4.2f, -2.5f, 0.0f, 148.3f, 12.8f},
				{-0.6f, -2.5f, 0.0f, 148.3f, 12.8f},
				{-0.6f, -2.5f, 0.0f, 148.3f, 12.8f},
				{4.1f, -2.5f, 0.0f, 148.3f, 12.8f},
				{4.1f, -2.5f, 0.0f, 148.3f, 12.8f},
			},
			//第四种参数类型对应补弹打球
			{

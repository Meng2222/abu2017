...
gun_pose_t gUpperGunPosDatabase[LAND_NUMBER][UPPER_SHOOT_METHOD_NUMBER][ZONE_NUMBER] = \
{
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			{-7.6f, -5.4f, 0.0f, 130.0f, 0.0f},
			{-7.6f, -5.6f, 0.0f, 130.0f, 0.0f},
			{-3.6f, -5.3f, 0.0f, 130.0f, 0.0f},			
			{-3.6f, -5.5f, 0.0f, 130.0f, 0.0f},
			{-1.2f, -5.5f, 0.0f, 130.0f, 0.0f},
			{-1.2f, -5.3f, 0.0f, 130.0f, 0.0f}
		}
	}
};

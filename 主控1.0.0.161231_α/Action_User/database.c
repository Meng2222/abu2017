...
gun_pose_t gLeftGunPosDatabase[SHOOT_POINT_NUMBER][SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
	...
	//第三个发射位置，对应场地中点
	{
		...
		{//1#着陆台
		// {-12.5f, 11.0f, 18.6f, 98.0f, 12.0f},
		  {-32.6f, 19.7f, 16.0f, 18.0f, 94.0f},
		 //2#着陆台
		 {-14.6f, 24.8f, 16.8f, 17.0f, 92.0f},
		 //3#着陆台

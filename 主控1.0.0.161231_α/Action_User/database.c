...
/*******************************蓝场参数********************************/
	 ...
	 //第二组参数，对应场地中间发射点参数
	{
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-33.2f, 18.6f, 15.9f, 17.0f, 78.0f},
		 //2#着陆台
		 {-17.3f, 25.5f, 14.1f, 20.5f, 75.0f},
		 //3#着陆台
...
/**************************蓝场参数*******************************/
	...
	//第二组参数对应场地中央发射点参数
	{
		...
		//七号柱子对应参数
		{
			...
			//第三种参数类型对应打盘
			{
				{-4.8f, -6.0f, 0.0f, 135.0f, 10.0f},
				{-4.8f, -5.9f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -6.0f, 0.0f, 135.0f, 10.0f},
				{-1.0f, -5.7f, 0.0f, 135.0f, 10.0f},
				{3.7f, -6.0f, 0.0f, 135.0f, 10.0f},
				{3.7f, -5.7f, 0.0f, 135.0f, 10.0f},
			},
			//第四种参数类型对应补弹打球
			{
				{1.8f, 1.3f, 0.0f, 83.0f, 0.0f},

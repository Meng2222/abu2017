...
gun_pose_t gUpperGunPosDatabase[LAND_NUMBER][UPPER_SHOOT_METHOD_NUMBER][ZONE_NUMBER] = \
{
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			{-4.5f, -6.4f, 0.0f, 130.0f, 0.0f},
			{-2.3f, -6.4f, 0.0f, 130.0f, 0.0f},
			{0.5f, -6.2f, 0.0f, 130.0f, 0.0f},			
			{0.0f, -7.0f, 0.0f, 130.0f, 0.0f},
			{5.7f, -6.2f, 0.0f, 130.0f, 0.0f},
			{2.5f, -7.3f, 0.0f, 130.0f, 0.0f}
		}
	}
};

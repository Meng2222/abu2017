...
//		 {-13.6f, 25.3f, 17.3f, 20.0f, 95.0f},
		 ...
		 //6#着陆台
		 {1.4f,13.8f,9.0f,18.0f,112.0f},//myh
		 //{-3.6f,19.8f,2.0f,21.0f,124.0f}
		 //7#着陆台
		 {4.5f,36.2f, 2.0f,16.0f,52.0f}}
...
//		 {1.4f,10.0f,2.1f,118.0f,25.0f},
		...
		//第六类参数，对应新盘补弹落盘参数/孟雨皞是个智障
		 ...
		 {38.4f,17.4f,12.0f,99.0f,11.0f},//myh
		 //6#着陆台
		 {1.4f,14.3f,9.5f,117.0f,17.0f},//myh
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}}

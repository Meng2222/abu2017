...
/*******************************蓝场参数********************************/
		...
		{//1#着陆台
		 ...
		 {41.5f,7.0f, 7.9f,10.0f,110.0f},
		 //6#着陆台
		 {-3.5f,11.9f, 3.6f,23.0f,123.0f},
		 //7#着陆台
		 {6.0f, 25.4f,6.0f,16.0f,77.0f}},
		//第二类参数，对应新盘自动落盘参数
		{//1#着陆台
		  {-32.7f, 13.1f, 18.2f, 23.0f, 84.0f},
		 //2#着陆台
		 {-18.0f, 21.9f, 11.1f, 18.0f, 90.0f},
		 //3#着陆台
		 {1.2f, 26.4f, 6.6f, 19.0f, 91.0f},
		 //4#着陆台
		 {22.1f, 21.2f, 10.0f, 16.0f,93.0f},
		 //5#着陆台
		 {32.0f,17.1f, 1.1f,9.0f,105.0f},
		 //6#着陆台
		 {-6.5f,16.4f,-0.3f,15.0f,131.0f},
		 //7#着陆台
		 {4.5f,36.2f, 2.0f,14.0f,50.0f}},
...
/*****************************蓝场参数***************************/
		...
		//第四类参数，对应新盘补弹落盘参数
		{//1#着陆台
		 {-39.5f, 15.6f, 17.1f, 93.0f, 14.0f},
		 //2#着陆台
		 {-25.5f, 22.4f, 20.5f, 85.0f, 20.0f},
		 //3#着陆台
		 {1.8f, 26.7f, 6.1f, 92.0f, 20.0f},
		 //4#着陆台
		 {22.4f,22.2f,8.0f,92.0f,14.0f},
		 //5#着陆台
		 {34.7f,13.7f,18.2f,84.0f,21.0f},
		 //6#着陆台
		 {7.5f,18.4f,-0.3f,129.0f,7.0f},
		 //7#着陆台
		 {-1.0f,35.5f, 2.9f,50.0f,15.0f}}
#endif		 
...
/**************************红场参数*******************************/
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			{-6.8f, -4.3f, 0.0f, 130.0f, 0.0f},
			{-6.6f, -4.0f, 0.0f, 130.0f, 0.0f},
			{-1.6f, -3.8f, 0.0f, 130.0f, 0.0f},			
			{0.8f, -4.2f, 0.0f, 130.0f, 0.0f},
			{2.8f, -4.0f, 0.0f, 130.0f, 0.0f},
...
/**************************蓝场参数*******************************/
	...
	//七号柱子对应参数
	{
		...
		//第三种参数类型对应打盘
		{
			{-5.0f, -4.3f, 0.0f, 130.0f, 0.0f},
			{-5.0f, -4.5f, 0.0f, 130.0f, 0.0f},
			{-3.2f, -4.5f, 0.0f, 130.0f, 0.0f},			
			{-3.2f, -4.7f, 0.0f, 130.0f, 0.0f},
			{1.4f, -4.3f, 0.0f, 130.0f, 0.0f},
			{1.4f, -4.5f, 0.0f, 130.0f, 0.0f}
		},
		//第四种参数类型对应补弹打球
		{
			{0.8f, 1.3f, 0.0f, 114.0f, 0.0f},

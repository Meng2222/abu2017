...
gun_pose_t gLeftGunPosDatabase[SHOOT_POINT_NUMBER][SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
	...
	//第三个发射位置，对应场地中点
	{
		...
		// {-12.5f, 11.0f, 18.6f, 98.0f, 12.0f},
		 ...
		 //2#着陆台
		 {-12.6f, 24.8f, 16.8f, 15.0f, 96.0f},
		 //3#着陆台
		 {-2.0f, 30.4f, 2.1f, 20.0f, 99.0f},
		 //4#着陆台
		 {25.5f, 22.2f, 13.5f, 22.0f,91.0f},
		 //5#着陆台
		 {30.7f,17.6f, 5.9f,20.0f,98.0f},
		 //6#着陆台
		 {-8.6f,17.3f,-3.2f,23.0f,120.0f},
		 //7#着陆台
		 {7.5f,32.7f, 1.5f,15.0f,53.0f}}
	}
};
...
gun_pose_t gRightGunPosDatabase[SHOOT_POINT_NUMBER][SHOOT_METHOD_NUMBER][LAND_NUMBER] = \
{
	...
	//第三个发射位置，对应场地中点
	{
		...
		{//1#着陆台
		 ...
		 //3#着陆台
		 {-5.5f, 23.4f, 12.7f, 115.0f, 5.0f},
		 //4#着陆台
		 {16.3f, 17.3f, 12.1f, 109.0f,0.0f},
		 //5#着陆台
		 {33.8f,10.5f, 12.4f,110.0f,0.0f},
		 //6#着陆台
		 {-1.6f,8.5f, 8.0f,119.0f,24.0f},
		 //7#着陆台
		 {-3.5f,24.9f, 7.0f,16.0f,71.0f}},
		...
		{//1#着陆台
		 ...
		 //3#着陆台
		 {2.8f, 24.4f, 6.1f, 95.0f, 19.0f},
		 //4#着陆台
		 {16.3f, 22.1f, 19.1f, 89.0f,20.0f},
		 //5#着陆台
		 {33.5f,17.5f,19.9f,96.0f,15.0f},
		 //6#着陆台
		 {-8.0f,23.8f, 20.0f,121.0f,22.0f},
		 //7#着陆台
		 {-9.0f,34.5f, 8.4f,12.0f,56.0f}}

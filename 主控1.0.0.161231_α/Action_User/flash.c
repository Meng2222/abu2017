...
void FlashInit(void)
{
	...
	Flash_ReadFloat((float *)gLeftGunReloadPosDatabase, FLASH_SECTOR_6_BLOCK_BASE_ADDRESS, LEFTGUNPOSDATABASE_FLOAT_NUM);
	Flash_ReadFloat((float *)gRightGunReloadPosDatabase, \
					FLASH_SECTOR_6_BLOCK_BASE_ADDRESS + 4 * LEFTGUNPOSDATABASE_FLOAT_NUM, \
					RIGHTGUNPOSDATABASE_FLOAT_NUM);

...
#define CLAMP_CLOSE_IO_ID 2
#define CLAMP_ROTATE_IO_ID 3
#define LEFT_RELOAD_IO_ID 4
#define LEFT_RELOAD_RESET_IO_ID 5
#define RIGHT_RELOAD_IO_ID 6
#define RIGHT_RELOAD_RESET_IO_ID 7
#define LEFT_SHOOT_IO_ID 8
#define RIGHT_SHOOT_IO_ID 9
#define UPPER_SHOOT_IO_ID 10

#define CLAMP_OPEN_BOARD_ID 1
#define CLAMP_CLOSE_BOARD_ID 1
#define CLAMP_ROTATE_BOARD_ID 1
#define LEFT_RELOAD_BOARD_ID 1
#define LEFT_RELOAD_RESET_BOARD_ID 1
#define RIGHT_RELOAD_BOARD_ID 1
#define RIGHT_RELOAD_RESET_BOARD_ID 1
#define LEFT_SHOOT_BOARD_ID 1
